...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->
        ...
        <link rel="stylesheet" href="styles/06859ae6.main.css">
</head>
  <body ng-app="pdifferenceApp">
    <!--[if lt IE 7]>
    ...
    <script src="bower_components/jquery/jquery.js"></script>
		...
		<script src="bower_components/mousetrap/plugins/global-bind/mousetrap-global-bind.min.js"></script>
    ...
    <script src="Session.js"></script>
        ...
        <script src="scripts/9e831593.modules.js"></script>

        <script src="scripts/56c2845f.scripts.js"></script>
</body>
</html>